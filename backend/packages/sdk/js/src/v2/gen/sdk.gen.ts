...
export class Instance extends HeyApiClient {
    ...
    /**
     * Install a skill and create its agent
     *
     * Writes the skill and agent config into the project .opencode directory, then reloads agents and skills.
     */
    public skillInstall<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
        workspace?: string;
        name?: string;
        description?: string;
        ...
        return (options?.client ?? this.client).post<InstanceSkillInstallResponses, InstanceSkillInstallErrors, ThrowOnError>({
            url: '/skill/install',
            ...options,
            ...params,
            headers: {
     ...
     */
    public skillInstallDirectory<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
    }, options?: Options<never, ThrowOnError>) {
        const params = buildClientParams([parameters], [{ args: [{ in: 'body', key: 'directory' }] }]);
        return (options?.client ?? this.client).post<InstanceSkillInstallDirectoryResponses, InstanceSkillInstallDirectoryErrors, ThrowOnError>({
     ...
     */
    public thesisCreate<ThrowOnError extends boolean = false>(parameters?: {
        title?: string;
        description?: string;
    }, options?: Options<never, ThrowOnError>) {
        const params = buildClientParams([parameters], [{ args: [{ in: 'body', key: 'title' }, { in: 'body', key: 'description' }] }]);
        return (options?.client ?? this.client).post<InstanceThesisCreateResponses, InstanceThesisCreateErrors, ThrowOnError>({
            url: '/thesis/create',
            ...options,
            ...params,
            headers: {
     ...
     */
    public thesisUpload<ThrowOnError extends boolean = false>(parameters?: {
        projectID?: string;
        filename?: string;
        content?: string;
    }, options?: Options<never, ThrowOnError>) {
        ...
        return (options?.client ?? this.client).post<InstanceThesisUploadResponses, InstanceThesisUploadErrors, ThrowOnError>({
            url: '/thesis/upload',
            ...options,
            ...params,
            headers: {
     ...
     */
    public thesisPdfText<ThrowOnError extends boolean = false>(parameters?: {
        projectID?: string;
        filename?: string;
    }, options?: Options<never, ThrowOnError>) {
        const params = buildClientParams([parameters], [{ args: [{ in: 'body', key: 'projectID' }, { in: 'body', key: 'filename' }] }]);
        return (options?.client ?? this.client).post<InstanceThesisPdfTextResponses, InstanceThesisPdfTextErrors, ThrowOnError>({
            url: '/thesis/pdf-text',
            ...options,
            ...params,
            headers: {
